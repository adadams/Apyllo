...
def evaluate_default_priors(
    ...
    for distribution_function, distribution_parameter_set, input_value in zip(
        distribution_functions, distribution_parameter_sets, input_values
    ):
        prior_distribution = priors[distribution_function]
        prior_distribution.generate_prior(distribution_parameter_set)

        evaluated_prior = prior_distribution.evaluate_prior_from_input(
            input_value, sampler_type
        )
