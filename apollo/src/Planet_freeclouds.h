...
public:
  ...
  //   vector<vector<double>> cloudtau,
  //   vector<vector<double>> cloudw0,
  //   vector<vector<double>> cloudasym
  //   );
  ...
  vector<vector<double>> setCloudTau(vector<vector<double>> cloudtau);
  vector<vector<double>> setCloudW0(vector<vector<double>> cloudw0);
  vector<vector<double>> setCloudAsym(vector<vector<double>> cloudasym);
  double getTeff();
