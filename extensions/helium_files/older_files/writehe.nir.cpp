...
int main()
{
  ...
  string buffer;
  char* s = new char[100];
  //ifstream ifile("hespec.dat");
  //ifstream ifile("CIA.dat");
  ifstream ifile("new_he.dat");
  ofstream ofile;
  ofile.open("he.nir.dat");
  ...
  ofile << "18 -6.0 2.5 36 1.875061263 3.599199194 21204 " << lmin << " " << lmax << " " << resolv << "\n";
